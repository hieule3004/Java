...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        while (!grid.areAllSunk()) {
            ...
            System.out.print("Make an attack: ");
            Coordinate coordinate = Util.parseCoordinate(input.nextLine());
            grid.attackCell(coordinate);
        }
        System.out.println("All ships sunken. GAME OVER!");
    }

    static void printHitMessage() {
